...
/**
 * @Entity Declaring the RadioButton Entity class as a Room Entity
...
public class RadioButtonEntity {
    /**
     * RadioButton Entity class ia a modal that represents the RadioButton Table
    ...
    /**
     * Instantiates a new Radio button entity.
     */
