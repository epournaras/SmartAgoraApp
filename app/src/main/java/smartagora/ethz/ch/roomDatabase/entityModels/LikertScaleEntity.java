...
/**
 * @Entity Declaring the LikertScale Entity class as a Room Entity
...
public class LikertScaleEntity {
    /**
     * LikertScale Entity class ia a modal that represents the LikertScale Table
    ...
    /**
     * Instantiates a new Likert scale entity.
     */
    public LikertScaleEntity() {
    }
