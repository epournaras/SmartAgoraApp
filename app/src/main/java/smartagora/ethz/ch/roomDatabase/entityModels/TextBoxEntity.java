...
/**
 * @Entity Declaring the TextBox Entity class as a Room Entity
...
public class TextBoxEntity {
    /**
     * TextBox Entity class ia a modal that represents the TextBox Table
    ...
    /**
     * Instantiates a new Text box entity.
     */
